...
public static class AppResourceExtensions
{
	public static void AddCustomResources(this App app)
	{
		...
		Core.Device.Fonts.FontProfileResult result = fontStyleService.GetFontProfile();
		Core.Device.Fonts.FontProfile profile = result.Profile;
		Core.Device.Fonts.FontSet fontSet = result.FontSet;
